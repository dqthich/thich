...
<div class="container">
<h2 style="color:rgb(75, 163, 235);text-align:center;">CẬP NHẬT THÔNG TIN NHÂN VIÊN</h2>
<div class="row">
        ...
        <?php
         ...
         $m = $_GET['item'];
				...
				$hh ="select * from nhanvien where Manv='".$m."'";
				$tour = mysqli_query($conn, $hh);
            //	$stt=1;
                $sql = "select * from chucvu";
                $re =  mysqli_query($conn,$sql) or die(mysql_error());
				echo "<form method='post' action='thuchiencapnhatnv.php' onsubmit = 'return thongbao4()' id='tt'>";
          ...
          echo "<div  class='card float-left' style='width: 1150px;text-lign:center;'>";
           // echo "<form method='post' action='thuchiencapnhat.php' onsubmit ='return thongbao2()'>";
              ...
              echo "<td>Tên nhân viên <input  class='form-control' type='text' name='tnv' value='".$row['HoTenNV']."'/></td>";echo"<br/>";
              
              echo "<td>Chức vụ </td>";
                              
                             
              echo "<select  class='form-control' name='macv'>";
              ...
              echo "</select>";echo"<br/>";
              echo "<td>Địa chỉ <input  class='form-control' type='text' name='diachi' value='".$row['DiaChi']."'/></td>";echo"<br/>";
              echo "<td>Số điện thoại <input  class='form-control' type='text' name='sdtnv' value='".$row['SoDienThoai']."'/></td>";echo"<br/>";
              echo "<td>Pass <input  class='form-control' type='text' name='passnv' value='".$row['Pass']."'/></td>";echo"<br/>";

              echo "<p style='text-align: center;'><input type ='submit'  style='text-align: center;' name= 'capnhatnv' value ='Cập nhật'class='btn btn-primary timkiem'/></p>";
