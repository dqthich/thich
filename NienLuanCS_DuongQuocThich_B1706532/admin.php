    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark " >
            ...
            <ul class="navbar-nav mr-auto ">
                ...
                <li class="nav-item new1">
                    <a class="nav-link" href="dangkynv.html">Tạo tài khoản </a>
                </li>
                <li class="nav-item new1">
...
<h2 style="color:rgb(75, 163, 235);text-align:center;">THÔNG TIN CÁC TOUR CHỜ DUYỆT</h2>
  ...
  <table class="table">
    ...
    <tbody >
      <?php
		...
		$sql = "select * from dattour as a, tour as b, khachhang as c where  a.Matour=b.Matour and a.MSKH=c.MSKH and a.TrangThai=''";
        ...
        echo "<form method='post' action='duyettour.php' onsubmit = 'return thongbao3()'>";
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<tr>";
                    ...
                    echo "<input type='checkbox' name='masotour[]' value='".$row['Masotour']."'/>";
                    echo "</td>";
                echo "</tr>";
                $stt++;
            }
