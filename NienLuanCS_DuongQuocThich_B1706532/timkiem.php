...
<body>
      ...
      <div class="col-md-7">
        ...
        <nav class=" navbar-light bg-light new5">
          <form class="form-inline" action="timkiem.php" method="post">
            <input class="form-control mr-sm-2" style="width: 530px;" name= "search" id= "search" type="search" placeholder="Bạn muốn đi đâu ?" aria-label="Search">
            <button class="btn btn-outline-success my-2 my-sm-0 bg-primary new6"  name="btn_tk"  id="btn_tk" type="submit">Tìm kiếm</button>
          </form>
        </nav>
        </P >
      </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary " >
            ...
            <ul class="navbar-nav mr-auto ">
                ...
                <li class="nav-item dropdown new2" style="width:120px;">
                    <a class="nav-link dropdown-toggle " href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-user" aria-hidden="true"></i> <?php session_start(); ?>
                          <?php 
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <p class="mien">
        <a href="#">Tour Miền Bắc</a>&nbsp;&nbsp;&nbsp;<a href="#">Tour Miền Trung</a>&nbsp;&nbsp;&nbsp;<a href="#">Tour Miền Nam</a>
    <p>
    <div class="container "style="text-align:center;">
        ...
        <div class="col-md-12 ">
                ...
                <?php
                    if(isset($_POST["btn_tk"])){
                        $search = $_POST["search"];
                        $conn = mysqli_connect("localhost", "root", "","quanlydulich");
                        $sql = "select * from tour where Tentour like '%$search%'";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_array($result);
                    
                       /* $sql2= "select * from nhomhanghoa where MaNhom like '".$row["MaNhom"]."'";
                        $result1 = mysqli_query($conn, $sql2);
                        $row1 = mysqli_fetch_array($result1);
                        
                        echo "<h3>".$row1["TenNhom"]."<h3>"; */
