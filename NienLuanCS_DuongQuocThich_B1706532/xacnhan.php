...
<h2 style="color:rgb(75, 163, 235);text-align:center;">CÁC TOUR ĐÃ ĐƯỢC XÁC NHẬN</h2>
  ...
  <table class="table">
    ...
    <tbody >
      <?php
        ...
        $sql = "select * from dattour as a, tour as b, khachhang as c, nhanvien as d 
                        where  a.Matour=b.Matour and a.MSKH=c.MSKH and a.Manv=d.Manv and a.TrangThai='Đã xác nhận' ";
		$result = mysqli_query($conn, $sql);
        $stt = 1;
        echo "<form method='post' action='duyettour.php' onsubmit = 'return thongbao3()'>";
            while($row = mysqli_fetch_array($result)){
            
            
                echo "<tr>";
                    echo "<td>$stt</td>";
                    echo "<td style='width: 110px;'>".$row['Masotour']."</td>";
                    echo "<td>".$row['Tentour']."</td>";
                    echo "<td>".number_format($row['Giatour'])." VND</td>";
                    echo "<td style='width: 170px;'>".$row['HoTenKH']."</td>";
                    echo "<td style='width: 140px;'>".$row['SoDienThoai']."</td>";
                    echo "<td>".$row['NgayBD']."</td>";
                    echo "<td>".$row['NgayKT']."</td>";
                    echo "<td style='width: 100px;'>".$row['DiaChi']."</td>";
                    echo "<td style='width: 130px;'>".$row['HoTenNV']."</td>";
                    echo "<td style='width: 130px;'>".$row['TrangThai']."</td>";
          ...
          //  echo "<p style='text-align: center;'><input type ='submit' style='text-align: center;' name= 'duyettour' value ='DUYỆT TOUR'class='btn btn-primary timkiem'/></p>";
		echo "</form>";
		echo "</td></tr>";
	  ?>
